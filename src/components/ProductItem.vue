    ...
    <div class="wrapper">
      ...
      <div class="product-detail">
        ...
        <div class="product-rate">
          ...
          <div class="product-rate-num">(3)</div>
        </div>
        ...
        <div class="policy">
          <div class="pickup">
            ...
            <div class="policy-text">
              <strong>Free Pick Up at 5830 E 2nd St #96683</strong> — (5830 E
              2nd St #96683, Casper) <br />
          ...
          <div class="delivery">
            ...
            <div class="policy-text">
              <strong>Free delivery</strong> — on all orders over $40!
            </div>
          </div>
          ...
          <div class="secure">
            ...
            <div class="policy-text">
              <strong>Secure checkout</strong> <span>with</span>
        ...
        <div class="tabs">
          <div class="tab">
            <a class="tab-button" @click="openTab('tab1')">
              <span class="name">Key highlights</span>
              <span class="more"><i class="fa-solid fa-angle-down"></i></span>
            </a>
            <div class="text" :class="{ open: activeTab == 'tab1' }">
              <p>
                <strong
                  >Our premium body products moisturize and soothe dry
                  skin.</strong
                >
                Infused with natural ingredients such as Shea Butter, Jojoba
                Oil, and Vitamin E, they deliver a calming blend of aromas that
                provides an experience like no other. Enjoy the natural and
                organic benefits of our products today.
              </p>
              <div class="image-cover">
                <img
                  src="/images/detail/key-highlight.jpg"
                  alt="key-highlight"
                />
              </div>
            </div>
          ...
          <div class="tab">
            <a class="tab-button" @click="openTab('tab2')">
              <span class="name">Key highlights</span>
              <span class="more"><i class="fa-solid fa-angle-down"></i></span>
            </a>
            <div class="text" :class="{ open: activeTab == 'tab2' }">
              <p>
                <strong
                  >Our premium body products moisturize and soothe dry
                  skin.</strong
          ...
          <div class="tab">
            <a class="tab-button" @click="openTab('tab3')">
              <span class="name">Key highlights</span>
              <span class="more"><i class="fa-solid fa-angle-down"></i></span>
            </a>
            <div class="text" :class="{ open: activeTab == 'tab3' }">
              <p>
                <strong
                  >Our premium body products moisturize and soothe dry
                  skin.</strong
